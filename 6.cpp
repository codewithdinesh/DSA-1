/*
Assignment No 6: Represent a given graph using adjacency matrix/list to perform DFS and using
...
Enter the vertex:f
Enter adjancy list:
For vertex a enter the number of connected vertces:3
...
c d b
For vertex b enter the number of connected vertces:1
Enter 1 connected vertex
a
Connected vertex:
a
For vertex c enter the number of connected vertces:2
Enter 1 connected vertex
a
Enter 2 connected vertex
e
Connected vertex:
a e
For vertex d enter the number of connected vertces:2
Enter 1 connected vertex
a
Enter 2 connected vertex
f
Connected vertex:
a f
For vertex e enter the number of connected vertces:1
Enter 1 connected vertex
c
Connected vertex:
c
For vertex f enter the number of connected vertces:1
Enter 1 connected vertex
d
Connected vertex:
d
